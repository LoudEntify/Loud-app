...
//
//   ONE AT A TIME, 3 MINUTES APART. Anything faster reads as a
...
//   with seven prompts behind them would otherwise face 21 minutes of
//   catch-up. The three most recent are also the most answerable: they
...
export const CATCHUP_SPACING_MS = 3 * 60 * 1000;
 ...
 * has already answered. `seenIds` is what has already been put in front
 * of them this session, so a dismissed card is not offered again in a
 * loop — dismissing is an answer of sorts, and repeating it is nagging.
 */
