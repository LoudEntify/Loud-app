...
// is the primary source of interest here (Item 4c), so the technique
// chance is much higher than the normal per-framing rates above; the
// remaining share holds the current shot longer instead of cutting.
const SINGLE_CAM_TECHNIQUE_CHANCE = 0.7;
