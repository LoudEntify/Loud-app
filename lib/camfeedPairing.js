...
// ─── WHAT COUNTS AS PART OF THE RIG (item 2) ──────────────────
// Defined in lib/pairingLiveness.js, not here, and re-exported so callers
// keep importing from this one module. That file has no 'server-only'
// import, which is what makes the predicate runnable by
// scripts/window-tests.mjs — see its header for why that matters.
export { PAIRING_LIVENESS_MS, isLivePairing } from './pairingLiveness.js';
